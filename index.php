...
<meta name="title" property="og:title" content="Enter your title here">
    ...
    <meta property='og:url' content='https://hitin.tech/project3'/>

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta
      property="og:url"
      content="https://hitin.tech/Online-Exam-System/assets/link-image.png"
    />
    <meta property="og:title" content="ज्ञान-Sphere" />
    <meta
      property="og:description"
      content="Click here to open this project"
    />
    <meta
      property="og:image"
      content="https://hitin.tech/project3/assets/link-image.png"
    />
    ...
    <meta
      ...
      content="https://www.hitin.tech/"
    />
    <meta property="twitter:title" content="ज्ञान-Sphere" />
    <meta
      property="twitter:description"
      content="ज्ञान-Sphere"
    />
    <meta
      property="twitter:image"
      content="https://www.hitin.tech/project3/assets/link-image.png"
    />
...
<div class="form-group">
<input type="password" name="password" maxlength="40" placeholder="Password" class="form-control"/>
</div>
...
<div class="form-group">
<input type="text" name="uname" maxlength="40"  placeholder="Teacher user id" class="form-control"/> 
</div>
<div class="form-group">
<input type="password" name="password" maxlength="40" placeholder="Password" class="form-control"/>
</div>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    ...
    <div class="col-sm-4">
      ...
      <h4>QA Tested</h4>
      <p>Tested in multiple colleges in India..</p>
    </div>
    <div class="col-sm-4">
...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
          <a href="https://www.linkedin.com/in/hitin-sharma-431a8723b/">
        <img src="assets/photo.jpg" alt="Hitin" width="400" height="300">
        </a>
        <p><strong>Hitin Sharma</strong></p>
        <p>NIET 3rd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <a href="https://www.linkedin.com/in/anushka-soni-2a17b6207/">  
        <img src="assets/profilepic.jpg" alt="Anushka" width="400" height="300">
        </a>
        <p><strong>Anushka Soni</strong></p>
        <p>NIET 3rd year BTECH</p>
      </div>
    </div>
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good initiative. I am so happy with the result!"<br><span>Rohit Choudhary, Asst. Professor, NIET</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>Bhanu Pratap Singh, Student, NIET</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>Surya Prakash Sharma, Asst. Professor, NIET</span></h4>
      </div>
    </div>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2>About Page</h2><br>
      <h4><b>ज्ञान-Sphere</b> is conducting a test online to measure the knowledge of the participants on a given topic. In the olden days everybody had to gather in a classroom at the same time to take an exam. With online examination students can do the exam online, in their own time and with their own device, regardless where they live. You only need a browser and a stable internet connection. </h4><br>
      <p><b>ज्ञान-Sphere</b> is a platform to hold online examinations. It caters to many requirements of holding online examinations. The system can generate statistical data for records. The system makes it possible to maintain a repository of questions, and then generate papers at a later stage, such that the lecturer has more flexibility over holding online quizzes. Furthermore, it provides the functionality to mark the papers automatically.</p> 

      <br><button onclick="window.location.href = 'social.html';"class="btn btn-default btn-lg">Get in Touch</button>
    </div>
    <div class="col-sm-4">
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 8630003793 </p>
      <p><span class="glyphicon glyphicon-envelope"></span><a href="mailto:hitinsharma@yahoo.com"> hitinsharma@yahoo.com</a></p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(28.46308344240189, 77.4906166818764);
...
<footer id="footer">
      <div class="container">
        <a href="mailto:hitinsharma@yahoo.com">hitinsharma@yahoo.com</a>
        <!-- Social links -->
        <div class="social">
          <a href="https://www.facebook.com/hitin.sharma.33/" target="_blank"
            ><img src="./assets/facebook-icon.svg" alt="Facebook"
          /></a>
          <a href="https://twitter.com/HitinSharma7" target="_blank"><img src="./assets/twitter-icon.svg" alt="Twitter" /></a>
          <a href="https://www.linkedin.com/in/hitin-sharma-431a8723b/" target="_blank"
            ><img src="./assets/linkedin-icon.svg" alt="Linkedin"/></a>
          <a href="https://github.com/hitinsharma" target="_blank"><img src="./assets/github-icon.svg" alt="GitHub" /></a>
          <a href="https://www.youtube.com/channel/UCHW_a3tiNE1DMYt32oHubUw" target="_blank"><img src="./assets/youtube-icon.svg" alt="Youtube" />
            
         <i class="fab fa-youtube"></i></a>
        </div>
  
        <p>Copyright &copy; hitin.tech 2024 <span id="datee"></span>, All rights reserved</p>
      </div>
    </footer>
